describe("Tlt-carpentry Web", async () => {
  it("home page", async () => {
    await browser.url(
      "http://tlt-carpentry-web.s3-website.ap-south-1.amazonaws.com/"
    );
  ...
  it("should navigate to the homepage and verify the logo is displayed", () => {
    browser.url("http://tlt-carpentry-web.s3-website.ap-south-1.amazonaws.com");
    const logo = $('img[(alt = "Logo")]');
